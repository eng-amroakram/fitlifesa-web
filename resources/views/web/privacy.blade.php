...
<head>
    ...
    <title>Fitlife SA - Privacy Policy </title>
...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to Fitlife, the software program provided by the Company.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Fitlife Company, Jeddah, Fatuh Al Buldan Street,
                    2690 .
                </p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Fitlife, accessible from <a href="https://fitlifesa.com"
                        rel="external nofollow noopener" target="_blank">https://fitlifesa.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: info@fitlife.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="https://fitlifesa.com/#contact-us"
                        rel="external nofollow noopener" target="_blank">https://fitlifesa.com/#contact-us</a></p>
            </li>
            <li>
                <p>By phone number: +966560784061</p>
            </li>
        </ul>
    </div>
