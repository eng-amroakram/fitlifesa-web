...
class MeasurementUnitsService extends Controller
{
    use ServiceHelper;

    public $name = "Measurement Units";
    public $title_creator = "Create";
    public $title_updater = "Update";
    public $modal_size = "";
    public $creator_id = "creator-button";
    public $updater_id = "updater-button";
    public $model = MeasurementUnit::class;

    public function data($filters, $sort_field, $sort_direction, $paginate = 10)
    {
        $paginate = $paginate == "all" ? MeasurementUnit::count() : $paginate;
        return MeasurementUnit::data()->filters($filters)
    ...
    {
        $this->model = new MeasurementUnit();
    }
    ...
    {
        return config('views.rows.measurement-units-service');
    }
    ...
    {
        return [
            ["title" => __("Measurement Unit Info"), "id" => "measuremen-unit-info", "status" => "active", "icon" => "fas fa-circle-info"],
        ];
    }
    ...
    public function contents($type)
    {
        ...
        $contents = [
            [
                "id" => "measuremen-unit-info",
                "title" => __("Measurement Unit Info"),
                "prev" => "",
                "next" => "",
                "type" => "text",
                "status" => "show active",
