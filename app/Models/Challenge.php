...
class Challenge extends Model
{
    ...
    protected $file_path = 'images/challeges';
    ...
    {
        return $query->select(['id', 'image', 'title_ar', 'title_en', 'description_ar', 'description_en', 'exercise_ids', 'status', 'created_at', 'updated_at']);
    }
    ...
    public function getExerciseNamesAttribute()
    {
        return getExerciseNames($this->exercise_ids);
    }

    public function getExerciseIdsAttribute($value)
    {
        return json_decode($value);
    }

    public function setExerciseIdsAttribute($value)
    {
        $this->attributes['exercise_ids'] = json_encode($value);
    }
    ...
    public function scopeGetMessages(Builder $builder)
    {
        return [
            ...
            "exercise_ids.required" =>  __("This field is required"),
        ];
    }
